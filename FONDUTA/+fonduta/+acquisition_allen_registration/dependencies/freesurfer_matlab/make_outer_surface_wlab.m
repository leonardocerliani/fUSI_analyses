function make_outer_surface_wlab (filled_volume, se_diameter, output_surface)
...
%     v2=[129-v(:,1) v(:,3)-129 110-v(:,2) ]; % in order to cope with the different orientation 
%     v=v2;
    v2 = (vol.vox2ras0*[v ones(size(v,1),1)]')';% Editted by Liang Wang on 2015/08/04 should use vox2ras
    v = v2(:,1:3);
%     v2 = (vol.tkrvox2ras*[v ones(size(v,1),1)]')'; % Editted by Chaoyi Qin on 2015/08/12 use tkrvox2ras
%     v=v2(:,1:3);
